...
NSString *const NeoWCMomentsTailEnabledKey = @"com.qiu7c.neowc.moments.tail.enabled";
NSString *const NeoWCMomentsTailAppIDKey = @"com.qiu7c.neowc.moments.tail.app-id";
...
NSString *const NeoWCMomentsInteractionReminderDetailsEnabledKey = @"com.qiu7c.neowc.moments.interaction-reminder.details";
NSString *const NeoWCMomentsCommentAntiDeleteEnabledKey = @"com.qiu7c.neowc.moments.comment-anti-delete";
NSString *const NeoWCMomentsCommentAntiDeleteTextKey = @"com.qiu7c.neowc.moments.comment-anti-delete.text";
NSString *const NeoWCMomentsCommentAntiDeleteFontSizeKey = @"com.qiu7c.neowc.moments.comment-anti-delete.font-size";
NSString *const NeoWCMomentsCommentAntiDeleteColorKey = @"com.qiu7c.neowc.moments.comment-anti-delete.color";
...
NSString *const NeoWCMomentsReminderForwardEnabledKey = @"com.qiu7c.neowc.moments.reminder.forward";
NSString *const NeoWCMomentsReminderForwardTargetKey = @"com.qiu7c.neowc.moments.reminder.forward-target";
NSString *const NeoWCMomentsReminderForwardImagesKey = @"com.qiu7c.neowc.moments.reminder.forward-images";
NSString *const NeoWCMomentsReminderForwardVideosKey = @"com.qiu7c.neowc.moments.reminder.forward-videos";
...
NSString *const NeoWCChatGlassStyleKey = @"com.qiu7c.neowc.chat.capsule-glass.style";
...
NSString *const NeoWCMessageRepeatMenuEnabledKey = @"com.qiu7c.neowc.chat.message-repeat-menu";
...
NSString *const NeoWCAutoSpeakerphoneEnabledKey = @"com.qiu7c.neowc.chat.auto-speakerphone";
NSString *const NeoWCCallRecordingEnabledKey = @"com.qiu7c.neowc.chat.call-recording";
NSString *const NeoWCCallVoiceDisguiseEnabledKey = @"com.qiu7c.neowc.chat.call-voice-disguise";
NSString *const NeoWCCallVoiceModeKey = @"com.qiu7c.neowc.chat.call-voice-mode";
NSString *const NeoWCCallRealtimeVoiceEffectEnabledKey = @"com.qiu7c.neowc.chat.call-realtime-voice-effect";
NSString *const NeoWCCallRealtimeVoiceEffectPresetKey = @"com.qiu7c.neowc.chat.call-realtime-voice-effect.preset";
