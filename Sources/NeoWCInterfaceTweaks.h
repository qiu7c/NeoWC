...
FOUNDATION_EXPORT NSString *const NeoWCChatInputCapsuleEnabledKey;
...
/// Applies two non-interactive glass backgrounds behind WeChat's existing input controls.
FOUNDATION_EXPORT void NeoWCApplyChatInputCapsulesToToolView(UIView *inputToolView);
FOUNDATION_EXPORT void NeoWCRestoreChatInputCapsulesFromToolView(UIView *inputToolView);
